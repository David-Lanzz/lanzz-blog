...
<div align="center">
  ...
  <h1><b>📖 Lanzz Blog</b></h1>
</div>

# 📗 Table of Contents

- [📗 Table of Contents](#-table-of-contents)
- [📖 Lanzz Blog ](#-lanzz-blog-)
...
# 📖 Lanzz Blog <a name="about-project"></a>

> This project is a simple blog application created using ruby on rails.
...
## 💻 Getting Started with Lanzz Blog <a name="getting-started"></a>
...
3. Ruby on rails installed on your machine

### Setup

Clone this [repository](https://github.com/David-Lanzz/lanzz-blog.git) to your desired folder:

```sh
  cd lanzz-blog
  git clone https://github.com/David-Lanzz/lanzz-blog.git
```
...
- Adding of various functionalities and interractions to the app
...
Feel free to check the [issues page](https://github.com/David-Lanzz/lanzz-blog.git).
